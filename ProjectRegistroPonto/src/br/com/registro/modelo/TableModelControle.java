...
public class TableModelControle extends AbstractTableModel{
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch(columnIndex){
            ...
            case 0:
                return this.listaTableControle.get(rowIndex).getIdControle();
            case 1:
                return this.listaTableControle.get(rowIndex).getHoraEntrada();
            case 2:
                return this.listaTableControle.get(rowIndex).getHoraAlmoco();
            case 3:
                return this.listaTableControle.get(rowIndex).getHoraRetornoAlmoco();
            case 4:
                return this.listaTableControle.get(rowIndex).getHoraSaida();
            case 5:
